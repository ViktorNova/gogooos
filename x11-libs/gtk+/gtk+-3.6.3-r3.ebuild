...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/gtk+/gtk+-3.6.3-r2.ebuild,v 1.3 2013/02/04 15:39:51 heroxbd Exp $
...
IUSE="aqua broadway colord cups debug egl examples +introspection packagekit test vim-syntax wayland X xinerama"
REQUIRED_USE="
	|| ( aqua wayland X )
	xinerama? ( X )"
...
COMMON_DEPEND="X? (
	...
	wayland? (
		...
		egl? ( >=x11-libs/cairo-1.11.3[opengl] )
	)
