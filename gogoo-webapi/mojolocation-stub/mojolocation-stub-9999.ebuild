...
DESCRIPTION="Stubbed implementation of the com.palm.location service"
...
src_install(){
	mkdir -p ${ED}/usr/palm/services/com.palm.location
	...
	cd ${WORKDIR}/${P}
        cp -rf *.json *.js ${ED}/usr/palm/services/com.palm.location
