...
DESCRIPTION="Underscore.js is a utility-belt library for JavaScript."
...
src_install(){
        ...
        cd ${WORKDIR}/${P}
	mkdir -p ${ED}/usr/palm/frameworks/underscore/version/1.0/
	cp -rf ${WORKDIR}/${P}/* ${ED}/usr/palm/frameworks/underscore/version/1.0/
}