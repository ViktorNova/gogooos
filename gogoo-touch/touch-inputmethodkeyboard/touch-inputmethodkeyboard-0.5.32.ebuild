...
DESCRIPTION="GoGoo Virtual Keyboard"
HOMEPAGE="https://github.com/dudochkin-victor/${PN}"
SRC_URI="https://github.com/dudochkin-victor/${PN}/tarball/${PV} -> ${P}.tar.gz"
S="${WORKDIR}/dudochkin-victor-${PN}-789472d"
...
#BuildRequires:  pkgconfig(ImEngine) >= 0.4.1
#BuildRequires:  pkgconfig(ImFramework) >= 0.20.0
#BuildRequires:  pkgconfig(gogootouch) >= 0.20.87
